...
export const desktopMessages = {
  ...
  byId: {
    ...
    "desktop.activation_failed": "Windows 未能激活 ChatGPT/Codex。请从开始菜单手动启动。",
    "desktop.launch_not_observed": "未发现可信的新桌面进程。请手动启动后重新扫描。",
    "desktop.close_failed": "无法请求 ChatGPT/Codex 正常关闭。请先保存任务并手动退出。",
    "desktop.close_timed_out": "ChatGPT/Codex 未在等待时间内正常关闭。",
    "desktop.force_terminate_failed": "无法安全强制关闭已确认的桌面进程。请手动退出后重试。",
    "desktop.force_not_authorized": "强制关闭确认已失效。请重新发起重启并先尝试正常关闭。",
    "desktop.identity_changed": "桌面进程身份已经变化，强制关闭已取消。请重新发起重启。",
    "desktop.restart_succeeded": "ChatGPT/Codex 已重新启动。",
    "desktop.action_unavailable": "桌面版当前不可执行该操作。",
