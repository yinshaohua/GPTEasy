...
export const providerMessages = {
  ...
  linuxExportOverwriteTitle: "覆盖已有导出文件？",
  linuxExportOverwriteMessage: (name: string) => `“${name}”已经存在。确认后才会原子替换原文件。`,
  linuxExportConfirmOverwrite: "确认覆盖",
  ...
  linuxExportOverwriteRequired: "目标文件已存在，需要再次确认覆盖。",
  ...
  wslSelectedProvider: "WSL2 目标供应商",
